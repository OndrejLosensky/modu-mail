...
export const SortableBlockWrapper: React.FC<SortableBlockWrapperProps> = ({ id, children }) => {
  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes}>
      <div className="group relative" {...listeners}>
        <div className="absolute -left-10 top-1/2 -translate-y-1/2 flex items-center justify-center w-6 h-6 rounded border bg-white text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing">

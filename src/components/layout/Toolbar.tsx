...
export const Toolbar: React.FC<ToolbarProps> = ({ blocks, onNewTemplate }) => {
  ...
  return (
    <>
      <div className="flex items-center justify-between gap-3 p-4 border-b border-gray-200 bg-white">
